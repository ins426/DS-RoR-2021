...
class AdministradorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrador" do
    assert_difference('Administrador.count') do
      post administradors_url, params: { administrador: { password: 'secret', password_confirmation: 'secret', username: @administrador.username } }
    end
  ...
  test "should update administrador" do
    patch administrador_url(@administrador), params: { administrador: { password: 'secret', password_confirmation: 'secret', username: @administrador.username } }
