...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { coveet_id: @comentario.coveet_id, cuerpo: @comentario.cuerpo, usuario_id: @comentario.usuario_id } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { coveet_id: @comentario.coveet_id, cuerpo: @comentario.cuerpo, usuario_id: @comentario.usuario_id } }
